...
namespace WCPPID{
  ...
  public:
    ...
    void set_particle_type(int type){particle_type = type;};
    ...
    bool do_track_pid(std::vector<double>& L , std::vector<double>& dQ_dx, double compare_range = 35*units::cm, double offset_length = 0*units::cm, bool flag_force = false);
