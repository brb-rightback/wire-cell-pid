  ...
  , type(0)
{
  ...
  main_cluster->clustering_points(map_vertex_segments, map_segment_vertices, *ct_point_cloud, 2);
  ...
  //   (*it)->clustering_points(map_vertex_segments, map_segment_vertices, *ct_point_cloud);
  // }
