...
int WireCellPID::ToyFiducial::check_LM(WireCell::FlashTPCBundle *bundle, double& cluster_length){
...
int WireCellPID::ToyFiducial::check_LM_cuts(WireCell::FlashTPCBundle *bundle, double& cluster_length){
...
int WireCellPID::ToyFiducial::check_LM_bdt(WireCell::FlashTPCBundle *bundle, double& cluster_length){
